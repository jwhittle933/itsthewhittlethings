    ...
    render() {
        return (
            <div className="svg-wrapper">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" version="1.1" width="20" height="20" className="comment-icon" onClick={ this.addComment }>
                    <g id="surface1">
                ...
                <Counter  count={this.state.currentComments} />
            </div>
        )
    }
}