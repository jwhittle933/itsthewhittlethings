...
const ThumbsUp = ({ votes, postId, upvote }) =>
    <div className="svg-wrapper">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16" className="thumbs-up" onClick={ () => upvote(postId) } >
